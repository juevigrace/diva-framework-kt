...
actual class DatabaseDriverProviderImpl(
    ...
    private val actualConfig: PlatformDriverConfig.Web = config as? PlatformDriverConfig.Web
        ?: error("PlatformDriverConfig must be Web")
    ...
    private class Builder : DatabaseDriverProvider.Builder {
        ...
        private lateinit var config: PlatformDriverConfig.Web
        ...
        override fun setPlatform(platform: PlatformDriverConfig): Builder {
            return when (platform) {
                is PlatformDriverConfig.Web -> {
                    apply { this.config = platform }
                }
                else -> {
                    apply {
                        this.config =
                            PlatformDriverConfig.Web(DriverConfig.SqliteDriverConfig("diva"))
                    }
                }
            }
        }
